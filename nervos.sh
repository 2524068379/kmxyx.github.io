...
##https://github.wuyanzheshui.workers.dev/nervosnetwork/ckb/releases/download/v0.16.0/ckb_v0.16.0_x86_64-unknown-linux-gnu.tar.gz
...
echo
##国内源没流量了，还得用国外源
ckb="https://github.wuyanzheshui.workers.dev/nervosnetwork/ckb/releases/download/"
ckbVersion="v0.16.0"
